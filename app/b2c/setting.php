...
'selllog.display.switch'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('前台是否显示销售记录'),'javascript'=>'$$(\'input[name^=set[selllog.display.switch]\').addEvent(\'click\',function(e){var row=this.getParent(\'tr\');if(this.checked&&this.get(\'value\')==\'true\'){row.getNext(\'tr\').show();if(this.name==\'set[selllog.display.switch]\')row.getNext(\'tr\').getNext(\'tr\').show();if(this.name==\'set[selllog.display.switch]\')row.getNext(\'tr\').getNext(\'tr\').getNext(\'tr\').show();}if(this.checked&&this.get(\'value\')==\'false\'){row.getNext(\'tr\').hide();if(this.name==\'set[selllog.display.switch]\')row.getNext(\'tr\').getNext(\'tr\').hide();if(this.name==\'set[selllog.display.switch]\')row.getNext(\'tr\').getNext(\'tr\').getNext(\'tr\').hide();}});$$(\'input[name^=set[selllog.display.switch]\').each(function(el){el.fireEvent(\'click\');});'),//WZP
...
'selllog.display.member.price'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('销售记录是否显示销售价格')),

'site.login_close_autocomplete'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否关闭登陆时用户名自动补全')),
...
'site.market_rate'=>array('type'=>SET_T_STR,'default'=>'1.2','desc'=>'','javascript'=>'var _site_market_rate = $E("input[name^=\'set[site.market_rate]\']");if (_site_market_rate.value == "") _site_market_rate.value = "1.2";_site_market_rate.addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value <="1") _target.value="1.2";});','vtype'=>'positive','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('建议数值大于1，输入数值小于1则值自动设为1.2').'</span>'),
...
'site.member_price_display'=>array('type'=>SET_T_ENUM,'default'=>'0','desc'=>app::get('b2c')->_('会员价显示设定'),'options'=>array('1'=>app::get('b2c')->_('显示所有会员等级价格'),'2'=>app::get('b2c')->_('不显示会员价'),'3'=>app::get('b2c')->_('只显示会员价'),'4'=>app::get('b2c')->_('显示会员价同时显示所有会员等级价格') )),//guzhengxiao
...
'site.trigger_tax'=>array('id'=>'trigger_tax','type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否启用发票'),'javascript'=>'if(document.getElement("[name=\"set[site.trigger_tax]\"]:checked").value == "false") $$(".trigger_tax").getParent("tr").hide();'),//WZP
'site.personal_tax_ratio'=>array('class'=>'trigger_tax','type'=>SET_T_STR,'default'=>'0.05','desc'=>app::get('b2c')->_('个人发票税率'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('例：税率为5%请填写0.05，留空则前台不显示税率信息。').'</span>','javascript'=>'$$("input[name^=set[site.personal_tax_ratio]]").addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value == "0") _target.value = "";});','vtype'=>'number'),//WZP
'site.company_tax_ratio'=>array('class'=>'trigger_tax','type'=>SET_T_STR,'default'=>'0.05','desc'=>app::get('b2c')->_('公司发票税率'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('例：税率为5%请填写0.05，留空则前台不显示税率信息。').'</span>','javascript'=>'$$("input[name^=set[site.company_tax_ratio]]").addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value == "0") _target.value = "";});','vtype'=>'number'),//WZP
'site.tax_content'=>array('class'=>'trigger_tax','type'=>SET_T_STR,'default'=>'商品清单,电器,办公用品,其它','desc'=>app::get('b2c')->_('发票内容选项'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('多个发票内容选项请用英文“,”隔开，如为空则前台不显示该选项模块。').'</span>','javascript'=>'$$("input[name^=set[site.tax_content]]").addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value == "0") _target.value = "";});'),//WZP
...
'site.loginlogo'=>array('type'=>SET_T_IMAGE,'default'=>'','desc'=>app::get('b2c')->_('登录注册页左侧大图'),'backend'=>'public','extends_attr'=>array('width'=>200,'height'=>95),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('图片标准宽度为600*600').'</span>'),
...
'system.money.decimals'=>array('type'=>SET_T_ENUM,'default'=>2,'desc'=>app::get('b2c')->_('商品金额显示位数'),'options'=>array(0=>app::get('b2c')->_('无小数位'),1=>app::get('b2c')->_('1位小数'),2=>app::get('b2c')->_('2位小数'),3=>app::get('b2c')->_('3位小数'))),
'system.money.operation.carryset'=>array('type'=>SET_T_ENUM,'default'=>0,'desc'=>app::get('b2c')->_('商品价格进位方式'),'options'=>array(0=>app::get('b2c')->_('四舍五入'),1=>app::get('b2c')->_('向上取整'),2=>app::get('b2c')->_('向下取整'))),
...
'system.shopname'=>array('type'=>SET_T_STR,'vtype'=>'maxLength','default'=>app::get('b2c')->_('点此设置您商店的名称'),'desc'=>app::get('b2c')->_('商店名称'),'javascript'=>'validatorMap.set("maxLength",["最大长度32个字",function(el,v){return v.length < 33;}]);'),
...
'gallery.default_view'=>array('type'=>SET_T_ENUM,'default'=>'list','options'=>array('list'=>app::get('b2c')->_('列表'),'grid'=>app::get('b2c')->_('大图')),'desc'=>app::get('b2c')->_('商品列表默认展示方式')),

'gallery.open_type'=>array('type'=>SET_T_ENUM,'default'=>'self','options'=>array('self'=>app::get('b2c')->_('从当前页面跳转'),'new_page'=>app::get('b2c')->_('打开新页面')),'desc'=>app::get('b2c')->_('商品列表页中打开商品详情页方式')),
...
'comment.null_notice.discuss'=>array('type'=>SET_T_STR,'default'=>app::get('b2c')->_('如果您对本商品有什么评论或经验,欢迎分享!'),'desc'=>app::get('b2c')->_('商品评论(经验),发布权限')),
...
'gallery.display.pagenum'=>array('type'=>SET_T_INT,'default'=>'100','desc'=>app::get('b2c')->_('商品列表显示前多少页'),'javascript'=>'$$("input[name^=set[gallery.display.pagenum]]").addEvent("change",function(e){var _target = $(e.target)||$(e);if (_target.value == "" || _target.value == "0")_target.value = "100";});','vtype'=>'digits'),
'gallery.display.grid.colnum'=>array('type'=>SET_T_INT,'default'=>'4','desc'=>app::get('b2c')->_('搜索橱窗页每行显示数')),
'gallery.deliver.time'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('搜索列表排序是否启用发布时间')),
'gallery.comment.time'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('搜索列表排序是否启用评论次数')),
'site.associate.search'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('前台是否启用联想搜索')),

'site.cat.select'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表页是否启用分类筛选')),
'gallery.display.buynum'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否启用数量选择')),
'gallery.display.price'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否启用价格段筛选')),
'gallery.display.tag.goods'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否启用商品标签')),
'gallery.display.tag.promotion'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否启用促销商品搜索')),
'gallery.display.promotion'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否展示促销信息')),
'gallery.display.store_status'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否启用库存状态提示')),
'gallery.store_status.num'=>array('type'=>SET_T_INT,'default'=>'10','desc'=>app::get('b2c')->_('商品列表库存紧张数量'),'javascript'=>'$$("input[name^=set[gallery.store_status.num]]").addEvent("change",function(e){var _target = $(e.target)||$(e);if (_target.value == "" || _target.value == "0")_target.value = "10";});','vtype'=>'digits'),
'gallery.display.stock_goods'=>array('type'=>SET_T_BOOL,'default'=>true,'desc'=>app::get('b2c')->_('商品列表是否展示缺货商品')),
...
'site.show_storage'=>array('type'=>SET_T_ENUM,'default'=>'0','desc'=>app::get('b2c')->_('前台是否显示库存数量'),'options'=>array('1'=>app::get('b2c')->_('不显示库存提示'),'2'=>app::get('b2c')->_('显示库存数量提示'),'3'=>app::get('b2c')->_('启用库存提示规则') )),//guzhengxiao
...
'site.get_policy.method'=>array('type'=>SET_T_ENUM,'default'=>'1','options'=>array('1'=>app::get('b2c')->_('不使用积分'),'2'=>app::get('b2c')->_('按订单商品总价格计算积分 '),'3'=>app::get('b2c')->_('为商品单独设置积分  ')),'desc'=>app::get('b2c')->_('积分计算方式：'),'id'=>'site-get_policy-method','javascript'=>'$("site-get_policy-method").addEvent("change",function(e){var select = $("site-level-switch");if (this.value == "1"){$$(".site-get_policy-method_cancel").getParent("tr").hide();select.options[0].disabled = true; select.options[1].selected=true;}else {$$(".site-get_policy-method_cancel").getParent("tr").show();select.options[0].disabled = false; select.options[0].selected=true; if (this.value == "3") $$(".site-get_policy-method-goods-point_cancel").getParent("tr").hide(); else $$(".site-get_policy-method-goods-point_cancel").getParent("tr").show();}if ($("site-point-expired-t") && $("site-point-expired-t").checked == true){$$(".site-point-expired").getParent("tr").show();}else{$$(".site-point-expired").getParent("tr").hide();}});if ($("site-get_policy-method").getValue() == "1"){$$(".site-get_policy-method_cancel").getParent("tr").hide();}else{$$(".site-get_policy-method_cancel").getParent("tr").show();if ($("site-get_policy-method").getValue() == "3") $$(".site-get_policy-method-goods-point_cancel").getParent("tr").hide(); else $$(".site-get_policy-method-goods-point_cancel").getParent("tr").show();}'),
...
'site.point_deductible_value' =>array('type'=>SET_T_STR,'default'=>'0.01','desc'=>app::get('b2c')->_('积分抵扣金额的比例值'),'vtype'=>'required&&unsigned','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('折扣比例0.01=1%')."</span>",'class'=>'site-get_policy-method_cancel'),
...
'goods.show_order_sales.type'=>array('type'=>SET_T_BOOL,'default'=>'true','desc'=>app::get('b2c')->_('商品页是否显示订单促销信息')),
...
'site.checkout.receivermore.open'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('是否开启配送时间'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('开启后顾客下订单可以选择配送时间').'</span>','javascript'=>'$$(".site-checkout-receivermore-open").addEvent("click",function(e){var _el = e.target || e;if ($(_el).getValue() == "true"){$$(".site-checkout-receivermore-open_cancel").getParent("tr").show();if ($$(".site-checkout-special:checked").getValue() == "true"){$$(".site-checkout-special_cancel").getParent("tr").        show();}else{$$(".site-checkout-special_cancel").getParent("tr").hide();}}else{$$(".site-checkout-receivermore-open_cancel").getParent("tr").hide();$$(".site-checkout-special_cancel").getParent("tr").hide();}});if ($$(".site-checkout-receivermore-open:checked").getValue() == "true"){$$(".site-checkout-receivermore-open_cancel").getParent("tr").show();}else{$$(".site-checkout-receivermore-open_cancel").getParent("tr").hide();}','class'=>'site-checkout-receivermore-open'),
'site.checkout.special'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('是否启用指定日期'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('').'</span>','javascript'=>'$$(".site-checkout-special").addEvent("click",function(e){var _el = e.target || e;if ($(_el).getValue() == "true"){$$(".site-checkout-special_cancel").getParent("tr").show();}else{$$(".site-checkout-special_cancel").getParent("tr").hide();}});if ($$(".site-checkout-special:checked").getValue() == "true" && $$(".site-checkout-receivermore-open:checked").getValue() == "true"){$$(".site-checkout-special_cancel").getParent("tr").show();}else{$$(".site-checkout-special_cancel").getParent("tr").hide();}','class'=>'site-checkout-receivermore-open_cancel site-checkout-special'),
'site.checkout.hasnight'=>array('type'=>SET_T_BOOL,'default'=>false,'desc'=>app::get('b2c')->_('是否开启夜晚配送时间'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('设置为否时，订单将不会在夜晚配送（18:00~22:00）').'</span>','class'=>'site-checkout-special_cancel'),
'site.checkout.shortest'=>array('type'=>SET_T_INT,'default'=>'24','desc'=>app::get('b2c')->_('接单后配送最短所需的时间'),'vtype'=>'requireshortest','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('小时&nbsp;&nbsp;&nbsp;请输入0到72范围内的整数，用户下单后将无法指定在该时间段内配送').'</span>','class'=>'site-checkout-special_cancel'),
'site.combination.pay' => array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否开启组合支付'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('开启该功能支付用户在当前预存款不足的情况，可使用预存款+在线支付方式组合完成对订单支付').'</span>'),

'system.default_dc'=>array('type'=>SET_T_INT,'default'=>'1','desc'=>app::get('b2c')->_('Ĭid')),//WZP

//'site.order.send_type'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否要实时同步订单'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('开启后，联通ocs等之后支付信息将不能同步').'</span>'),

//'system.order.tracking'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否启用订单跟踪查询'),'helpinfo'=>'<span class=\'notice\' style=\'display:inline-block;vertical-align:top;margin-left:10px;\'>'.app::get('b2c')->_('说明：目前ECstore订单物流跟踪查询功能是采用快递100提供的免费API接口，该接口目前使用限制为2000次/天，<br>若商家需要无限制或使用其它快递查询接口服务，请另行咨询快递100或其它服务商获取。<br>参考：http://www.kuaidi100.com/help/qa.shtml#qa06').'</span>'),
