 ...
 */
final class weixin_payment_plugin_wxpayjsapi extends ectools_payment_app implements ectools_interface_payment_app {
    ...
    public function __construct($app){
        ...
        $this->notify_url = kernel::base_url(1).'/index.php/openapi/weixin/wxpayjsapi';
        #test
...
//          ),
    ...
    public function dopay($payment)
    {
        ...
        $parameters = array(
            ...
            'nonce_str'        => weixin_util::create_noncestr(),
