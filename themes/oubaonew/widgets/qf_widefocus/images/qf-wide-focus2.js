var Focus = new Class({
	...
	render: function() {
		...
		this.pageContainer = $(ops.pagebtns.id);
		...
		items.each(function(item, index){
			(index > 0) && item.setStyles('opacity',0);
		...
		this.leftBtn = $(ops.button.left).setStyle('opacity', 0);
		this.rightBtn = $(ops.button.right).setStyle('opacity', 0);
		this.css(0);
		this.attach();
	},
